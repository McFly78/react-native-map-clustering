...
const ClusteredMarker = ({
  ...
  return (
    <Marker
      ...
      style={{ zIndex: Platform.OS === 'android' ? points + 1: null }} // NM sinon sur IOS sinon les etiquettes apparaissent en dessous des Clusters, par contre les markers apparaissent au dessus des clusters
      // NM //style={{ zIndex: points + 1 }}
      onPress={onPress}
